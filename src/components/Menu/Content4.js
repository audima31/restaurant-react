          ...
          <div className="row">
            ...
            <div className="col ps-5">
              <div>
                ...
                <h1 className="fw-semibold namaMenuHome mt-1">Wine Pairing</h1>
                <p className="captionMenuHome mt-3 ">
                  ...
                  journey that enhances the richness of your meal, making every
                  moment a celebration of taste and sophistication.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="captionMenuHome mt-3 ">
                  ...
                  your meal. Experience a symphony of taste that celebrates the
                  art of pairing with nature's finest expressions.
                </p>
              </div>
              ...
              <div>
                ...
                <hr className="garisContent2Menu" />
                <h1 className="fw-semibold namaMenuHome mt-1">Whisky Flyer</h1>
                <p className="captionMenuHome mt-3 ">
                  ...
                  taste. Experience the allure of the amber elixir, where every
                  pour is a celebration of distinction.
                </p>
              </div>
            </div>
          </div>
